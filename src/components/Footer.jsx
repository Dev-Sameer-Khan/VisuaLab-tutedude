  ...
  <div className="text-[1vw] text-[#4e3c2f] mt-10 max-[599px]:mt-4 w-full flex pt-6 max-[1025px]:flex-col max-[1025px]:text-sm max-[1025px]:gap-4 max-[599px]:text-xs max-[599px]:gap-2">
    <div className="w-[55%] max-[1025px]:w-full">
      ...
      <p className="mt-1 max-[599px]:mt-2">
        Privacy Policy | Terms & Conditions | Accessibility Statement | Do Not
    ...
    <p className="w-[45%] mt-4 leading-tight max-[1025px]:w-full max-[1025px]:mt-2 max-[599px]:mt-3 max-[599px]:leading-snug">
      ...
      (U.S. Food & Drug Administration). The products sold on this website are
      not intended to diagnose, treat, cure, or prevent any disease. The
      information provided by this website or this company is not a substitute
      for a face-to-face consultation with your physician, and should not be
      construed as individual medical advice.
    </p>
  </div>
</footer>
