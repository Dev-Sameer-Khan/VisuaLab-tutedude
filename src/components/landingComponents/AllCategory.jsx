                ...
                <div className="flex flex-col gap-4">
                  <div className="img h-auto w-full bg-[#F3E7CF] rounded-2xl overflow-hidden">
                    <img
                      ...
                      src="https://us.foursigmatic.com/cdn/shop/files/vanilla-protein-shop-all.jpg?v=1735898320"
                      alt="product"
                    />
                  </div>
                  <div className="price flex flex-col gap-1">
                    ...
                    <p className="text-[1.2vw] max-[1025px]:text-lg max-[599px]:text-base">$35</p>
                  </div>
                  <a href="#">
